            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm mb-6 border border-white/20">
                        ...
                        <span>500+ new internships this week</span>
                    </div>
                    ...
                    <p className="text-lg sm:text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
                        India&apos;s smartest internship platform. AI-powered
                        matching connects you with opportunities at top
                        companies — tailored to your profile.
                    </p>
